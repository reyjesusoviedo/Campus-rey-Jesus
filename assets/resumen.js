  ...
  async function renderTeacher() {
    ...
    app.innerHTML = `
      <div class="hello"><div><h1>${greet}, <span>${esc(first)}</span></h1><p>Organiza tus clases y acompaña a tus alumnos.</p></div>
        <div class="new"><a href="escritorio.html" style="display:inline-block;background:#0c70bb;color:#fff;border-radius:12px;padding:12px 20px;font-weight:800;text-decoration:none;box-shadow:0 10px 24px rgba(12,112,187,.35)">＋ Preparar clase</a></div></div>
      <div class="rkpis">
      ...
      <div class="rgrid">
        ...
        <div class="rcard"><h3>⚡ Accesos rápidos</h3><div class="quick">
          <a href="escritorio.html"><span class="ic">🧰</span>Preparar clase<span class="arr">›</span></a>
